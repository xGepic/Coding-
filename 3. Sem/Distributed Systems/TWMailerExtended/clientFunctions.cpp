...
void printMenu()
{
    cout << "LOGIN - Log into your account" << endl;
...
////////////////////////////////////////////////////////////////////////////
// Function printCommands to cout the Usage Message
void printCommands()
{
...
void serverCommunication()
{
    ...
    do
    {
        ...
        {
            savedMessage = savedMessage + input;
            cout << "If you want to read from your received mails type: REC" << endl
                 << "If you want to read from the mails you sent type: SEN" << endl
                 << ">> ";
            fgets(input, BUFFER, stdin);
            savedMessage = savedMessage + input;
            cout << "Username:" << endl
        ...
        {
            savedMessage = savedMessage + input;
            cout << "If you want to list your received mails type: REC" << endl
                 << "If you want to list the mails you sent type: SEN" << endl
                 << ">> ";
            fgets(input, BUFFER, stdin);
            savedMessage = savedMessage + input;
            cout << "Username:" << endl
        ...
        {
            savedMessage = savedMessage + input;
            cout << "If you want to delete from your received mails type: REC" << endl
                 << "If you want to delete from the mails you sent type: SEN" << endl
                 << ">> ";
            fgets(input, BUFFER, stdin);
            savedMessage = savedMessage + input;
            cout << "Username:" << endl
